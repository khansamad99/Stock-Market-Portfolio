        ...
        return (
            <TableBody>
                <TableRow key={item._id}>
                  ...
                  <TableCell align="left">{item.buy[0].price}</TableCell>
                  <TableCell align="left">{item.sell[0].price}</TableCell>
                  <TableCell align="left">{item.buy[0].quantity}</TableCell>
        ...
        <Table className={classes.table} aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="left">Buy Price</StyledTableCell>
